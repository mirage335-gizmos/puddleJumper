...
Copyright (C) 2024 m335
See the end of the file for license conditions.
See license.txt for puddleJumper license conditions.


Fast equivalent to a USB flash drive without possibility of BadUSB attacks 
or unsafe bridging of networks. With appropriate OS hardening, buffer 
overflow through malformed network packets may be preventable. 
Configuration is performed for such a dedicated computer which is ONLY 
connected to one computer at a time.

Optical Data Diode is also still appropriate if possible, to completely 
eliminate improper data flow direction due to malformed network packets 
...
_t '
scriptedIllustrator_markup_uk4uPhB663kVcygT0q --><!-- # --><pre style="margin-top: 0px;margin-bottom: 0px;white-space: pre-wrap;">
DANGER: Do NOT connect a puddleJumper to multiple computers, or directly to 
a network bridge. ALWAYS connect directly to ONLY ONE computer.
<!-- # --></pre><!-- scriptedIllustrator_markup_uk4uPhB663kVcygT0q
'
 '_paragraph_end'
if false; then true; # -->
...
https://linux.die.net/man/5/vsftpd.conf
	MAJOR - &#39;Default: NO (but the sample config file enables 
it)&#39;
	MAJOR - delete_failed_uploads

https://serverfault.com/questions/243816/vsftpd-allow-access-only-for-certai
n-users
	&#39;userlist_enable=YES
...
https://askubuntu.com/questions/239239/error-message-500-oops-vsftpd-refusin
g-to-run-with-writable-root-inside-chroo
...
_t '
scriptedIllustrator_markup_uk4uPhB663kVcygT0q --><!-- # --><pre style="margin-top: 0px;margin-bottom: 0px;white-space: pre-wrap;">
This file is part of puddleJumper.

puddleJumper is free software: you can redistribute it and/or modify
it under the terms of the GNU Affero General Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.

puddleJumper is distributed in the hope that it will be useful,
but WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
GNU Affero General Public License for more details.

You should have received a copy of the GNU Affero General Public License
along with puddleJumper.  If not, see &lt;http://www.gnu.org/licenses/&gt;.
<!-- # --></pre><!-- scriptedIllustrator_markup_uk4uPhB663kVcygT0q
'
 '_paragraph_end'
if false; then true; # -->
